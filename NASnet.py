...
total_images = len(set(img_name_vector))
for img, path in tqdm(image_dataset,total= total_images):
...
checkpoint_path = "./checkpoints_nasnet/train"
...
with open('predicted_caption_nasnet.json','w') as j:
...
with open("predicted_caption_nasnet.json", 'r') as f:
...
with open('predicted_caption_nasnet_with_real_captions.json','w') as j:
...
with open("predicted_caption_nasnet_with_real_captions.json", 'r') as f:
    bleu_score_list = json.load(f)
