...
def load_image(image_path):
    ...
    img = tf.keras.applications.xception.preprocess_input(img)# __-- CHANGE THIS
...
image_model = tf.keras.applications.xception.Xception(include_top=False,
                                                weights='imagenet') # __ -- CHANGE THIS TO NEW MODEL
...
checkpoint_path = "./checkpoints_xception/train"
...
with open('predicted_caption_xception.json','w') as j:
...
with open("predicted_caption_xception.json", 'r') as f:
...
with open('predicted_caption_xception_with_real_captions.json','w') as j:
...
with open("predicted_caption_xception_with_real_captions.json", 'r') as f:
